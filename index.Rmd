...
To use methods in NumPy (and other modules) we need to use `numpy.method_name()`.
...
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` Indicates some optional Extra exercise to try while you're waiting for me to move on.
]
...
```
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` 1. Create a list, `python_list`  
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` 2. Import pandas and create a small data frame. You'll need the DataFrame() method from pandas. As arguments, it will take lists of lists the same length
]
...
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` What does `.size` give for the dataframe? Try `.shape`
]
...
Can youfind the mean of `python_array`
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` exercises median, max, min sum
]
--
...
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` Can you access the pandas dataframe? What sort of object is it?
]
