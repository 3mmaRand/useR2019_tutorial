...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdHXFrhsSfUXEyIhHAnP40fH5a66eRZm3YZaEcNFT-F08CKjA/viewform?embedded=true" width="640" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
...
As long as you know what the Python methods and code snippets are is for, and have a good-enough understanding of their inputs and outputs, then you can use `reticulate`
...
.footnote[
`r kableExtra::text_spec("Extra exercise", background = "darkturquoise", color = "black")` Indicates an optional extra exercise to try while you're waiting for me to move on.
]
...
.footnote[
`r kableExtra::text_spec("Extra exercise 1.", background = "darkturquoise", color = "black")` Create a list called `python_list`  
`r kableExtra::text_spec("Extra exercise 2.", background = "darkturquoise", color = "black")` Import pandas and create a small data frame. You'll need the DataFrame() method from pandas. As arguments, it will take lists of lists the same length
]
...
.footnote[  
`r kableExtra::text_spec("Extra exercise 3.", background = "darkturquoise", color = "black")` How do you need to organise the list of lists in the DataFrame() command to get a 4 rows and 2 columns compared to 2 rows and 4 columns.
]
...
.footnote[
`r kableExtra::text_spec("Extra exercise 4.", background = "darkturquoise", color = "black")` What does `.size` give for the the list and dataframe? Try `.shape`
]
...
.footnote[
`r kableExtra::text_spec("Extra exercise 5.", background = "darkturquoise", color = "black")` Find other summary statistics for the array  
`r kableExtra::text_spec("Extra exercise 6.", background = "darkturquoise", color = "black")` Is there a mean method for the dataframe? What about the list? Can you find the mean of your list?
]
--
...
.footnote[
`r kableExtra::text_spec("Extra exercise 7.", background = "darkturquoise", color = "black")` Can you access the list and dataframe?
]
...
.footnote[  
`r kableExtra::text_spec("Extra exercise 8.", background = "darkturquoise", color = "black")` How do the list and dataframe behave? 
]
...
.footnote[   
`r kableExtra::text_spec("Extra exercise 9.", background = "darkturquoise", color = "black")` What is the object translation for the list and dataframe object is it?
]
---
background-image: url(pics/reticulated_python.png)
background-position: 95% 7%
...
`r kableExtra::text_spec("RUN", background = "darkgreen", bold = TRUE, color = "white")`
